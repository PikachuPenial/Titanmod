...
function ImportHUDCode(ply, cmd, args)
	...
	ply:ConCommand("tm_hud_font " .. var[1])
	ply:ConCommand("tm_hud_bounds_x " .. var[2])
	ply:ConCommand("tm_hud_bounds_y " .. var[3])
	ply:ConCommand("tm_hud_text_color_r " .. var[4])
	ply:ConCommand("tm_hud_text_color_g " .. var[5])
	ply:ConCommand("tm_hud_text_color_b " .. var[6])
	ply:ConCommand("tm_hud_ammo_style " .. var[7])
	ply:ConCommand("tm_hud_ammo_bar_color_r " .. var[8])
	ply:ConCommand("tm_hud_ammo_bar_color_g " .. var[9])
	ply:ConCommand("tm_hud_ammo_bar_color_b " .. var[10])
	ply:ConCommand("tm_hud_health_size " .. var[11])
	ply:ConCommand("tm_hud_health_offset_x " .. var[12])
	ply:ConCommand("tm_hud_health_offset_y " .. var[13])
	ply:ConCommand("tm_hud_health_color_high_r " .. var[14])
	ply:ConCommand("tm_hud_health_color_high_g " .. var[15])
	ply:ConCommand("tm_hud_health_color_high_b " .. var[16])
	ply:ConCommand("tm_hud_health_color_mid_r " .. var[17])
	ply:ConCommand("tm_hud_health_color_mid_g " .. var[18])
	ply:ConCommand("tm_hud_health_color_mid_b " .. var[19])
	ply:ConCommand("tm_hud_health_color_low_r " .. var[20])
	ply:ConCommand("tm_hud_health_color_low_g " .. var[21])
	ply:ConCommand("tm_hud_health_color_low_b " .. var[22])
	ply:ConCommand("tm_hud_equipment_anchor " .. var[23])
	ply:ConCommand("tm_hud_equipment_offset_x " .. var[24])
	ply:ConCommand("tm_hud_equipment_offset_y " .. var[25])
	ply:ConCommand("tm_hud_enablekillfeed " .. var[26])
	ply:ConCommand("tm_hud_killfeed_style " .. var[27])
	ply:ConCommand("tm_hud_killfeed_limit " .. var[28])
	ply:ConCommand("tm_hud_killfeed_offset_x " .. var[29])
	ply:ConCommand("tm_hud_killfeed_offset_y " .. var[30])
	ply:ConCommand("tm_hud_killfeed_opacity " .. var[31])
	ply:ConCommand("tm_hud_killdeath_offset_x " .. var[32])
	ply:ConCommand("tm_hud_killdeath_offset_y " .. var[33])
	ply:ConCommand("tm_hud_kill_iconcolor_r " .. var[34])
	ply:ConCommand("tm_hud_kill_iconcolor_g " .. var[35])
	ply:ConCommand("tm_hud_kill_iconcolor_b " .. var[36])
	ply:ConCommand("tm_hud_obj_scale " .. var[37])
	ply:ConCommand("tm_hud_obj_color_empty_r " .. var[38])
	ply:ConCommand("tm_hud_obj_color_empty_g " .. var[39])
	ply:ConCommand("tm_hud_obj_color_empty_b " .. var[40])
	ply:ConCommand("tm_hud_obj_color_occupied_r " .. var[41])
	ply:ConCommand("tm_hud_obj_color_occupied_g " .. var[42])
	ply:ConCommand("tm_hud_obj_color_occupied_b " .. var[43])
	ply:ConCommand("tm_hud_obj_color_contested_r " .. var[44])
	ply:ConCommand("tm_hud_obj_color_contested_g " .. var[45])
	ply:ConCommand("tm_hud_obj_color_contested_b " .. var[46])
	ply:ConCommand("tm_hud_dmgindicator_color_r " .. var[47])
	ply:ConCommand("tm_hud_dmgindicator_color_g " .. var[48])
	ply:ConCommand("tm_hud_dmgindicator_color_b " .. var[49])
	ply:ConCommand("tm_hud_dmgindicator_opacity " .. var[50])
	ply:ConCommand("tm_hud_keypressoverlay_x " .. var[51])
	ply:ConCommand("tm_hud_keypressoverlay_y " .. var[52])
	ply:ConCommand("tm_hud_keypressoverlay_inactive_r " .. var[53])
	ply:ConCommand("tm_hud_keypressoverlay_inactive_g " .. var[54])
	ply:ConCommand("tm_hud_keypressoverlay_inactive_b " .. var[55])
	ply:ConCommand("tm_hud_keypressoverlay_actuated_r " .. var[56])
	ply:ConCommand("tm_hud_keypressoverlay_actuated_g " .. var[57])
	ply:ConCommand("tm_hud_keypressoverlay_actuated_b " .. var[58])
	ply:ConCommand("tm_hud_velocitycounter_x " .. var[59])
	ply:ConCommand("tm_hud_velocitycounter_y " .. var[60])
	net.Start("SendNotification")
