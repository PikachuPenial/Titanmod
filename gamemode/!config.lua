...
weaponArray[74] = {"tfa_ins2_eftm4a1", "M4A1", "primary", "rifle"}
weaponArray[75] = {"tfa_nam_m79", "M79", "primary", "explosive"}
weaponArray[76] = {"tfa_ins2_m9", "M9", "secondary", "pistol"}
weaponArray[77] = {"tfa_ilopn_m9_phrobis", "M9 Bayonet", "melee"}
weaponArray[78] = {"bocw_mac10_alt", "Mac 10", "secondary", "smg"}
weaponArray[79] = {"tfa_ararebo_bf1", "Mace", "melee"}
weaponArray[80] = {"tfa_ins2_pm", "Makarov", "secondary", "pistol"}
weaponArray[81] = {"tfa_tfre_maresleg", "Mare's Leg", "secondary", "pistol"}
weaponArray[82] = {"tfa_fml_lefrench_mas38", "Mas 38", "primary", "smg"}
weaponArray[83] = {"tfa_doimg34", "MG 34", "primary", "lmg"}
weaponArray[84] = {"tfa_doimg42", "MG 42", "primary", "lmg"}
weaponArray[85] = {"tfa_ins2_mk14ebr", "MK 14 EBR", "primary", "rifle"}
weaponArray[86] = {"tfa_ins2_mk23", "MK 23", "secondary", "pistol"}
weaponArray[87] = {"tfa_fml_inss_mk18", "MK18", "primary", "rifle"}
weaponArray[88] = {"tfa_ins2_swmodel10", "Model 10", "secondary", "pistol"}
weaponArray[89] = {"tfa_ins2_mosin_nagant", "Mosin Nagant", "primary", "sniper"}
weaponArray[90] = {"tfa_doimp40", "MP 40", "primary", "smg"}
weaponArray[91] = {"tfa_ins2_mp443", "MP-443", "secondary", "pistol"}
weaponArray[92] = {"tfa_ww1_mp18", "MP18", "primary", "smg"}
weaponArray[93] = {"tfa_inss2_hk_mp5a5", "MP5", "primary", "smg"}
weaponArray[94] = {"tfa_ins2_mp5k", "MP5K", "secondary", "smg"}
weaponArray[95] = {"tfa_ins2_mp7", "MP7", "primary", "smg"}
weaponArray[96] = {"tfa_ins2_warface_bt_mp9", "MP9", "primary", "smg"}
weaponArray[97] = {"tfa_jw_tti_mpx", "MPX", "primary", "smg"}
weaponArray[98] = {"tfa_ins2_mr96", "MR-96", "secondary", "pistol"}
weaponArray[99] = {"tfa_ins2_mc255", "MTs225", "primary", "shotgun"}
weaponArray[100] = {"tfa_bocw_nailgun", "Nailgun", "secondary", "pistol"}
weaponArray[101] = {"tfa_ins2_nova", "Nova", "primary", "shotgun"}
weaponArray[102] = {"tfa_bo3_nunchucks", "Nunchucks", "melee"}
weaponArray[103] = {"tfa_l4d2_osp18", "OSP-18", "secondary", "pistol"}
weaponArray[104] = {"tfa_ins2_ots_33_pernach", "OTs-33 Pernach", "secondary", "pistol"}
weaponArray[105] = {"tfa_doiowen", "Owen Gun", "primary", "smg"}
weaponArray[106] = {"tfa_ins2_p320_m18", "P320", "secondary", "pistol"}
weaponArray[107] = {"tfa_fml_p90_tac", "P90", "primary", "smg"}
weaponArray[108] = {"tfa_blast_pindadss2", "Pindad SS2", "primary", "rifle"}
weaponArray[109] = {"tfa_ins2_pkp", "PKP", "primary", "lmg"}
weaponArray[110] = {"tfa_ins2_pm9", "PM-9", "secondary", "smg"}
weaponArray[111] = {"tfa_fas2_ppbizon", "PP-19 Bizon", "primary", "smg"}
weaponArray[112] = {"tfa_nam_ppsh41", "PPSH", "primary", "smg"}
weaponArray[113] = {"tfa_ww2_pbz39", "PzB 39", "primary", "sniper"}
weaponArray[114] = {"tfa_ins2_norinco_qbz97", "QBZ-97", "primary", "rifle"}
weaponArray[115] = {"tfa_ins2_qsz92", "QSZ-92", "secondary", "pistol"}
weaponArray[116] = {"yurie_eft_red_rebel_axe", "Red Rebel", "melee"}
weaponArray[117] = {"tfa_ins2_remington_m870", "Remington M870", "primary", "shotgun"}
weaponArray[118] = {"tfa_ins2_pd2_remington_msr", "Remington MSR", "primary", "sniper"}
weaponArray[119] = {"tfa_ins2_rfb", "RFB", "primary", "rifle"}
weaponArray[120] = {"swat_shield", "Riot Shield", "secondary", "melee"}
weaponArray[121] = {"tfa_ins2_rpg7_scoped", "RPG-7", "primary", "explosive"}
weaponArray[122] = {"tfa_ins2_rpk_74m", "RPK-74M", "primary", "lmg"}
weaponArray[123] = {"tfa_ins2_s&w_500", "S&W 500", "secondary", "pistol"}
weaponArray[124] = {"tfa_ins2_izh43sw", "Sawed Off", "secondary", "shotgun"}
weaponArray[125] = {"tfa_ins2_scar_h_ssr", "SCAR-H", "primary", "rifle"}
weaponArray[126] = {"tfa_ins2_sc_evo", "Scorpion Evo", "primary", "smg"}
weaponArray[127] = {"tfa_l4d2_skorpion", "Skorpion", "secondary", "pistol"}
weaponArray[128] = {"tfa_ins2_sks", "SKS", "primary", "rifle"}
weaponArray[129] = {"tfa_ins2_spas12", "SPAS-12", "primary", "shotgun"}
weaponArray[130] = {"tfa_ins2_spectre", "Spectre M4", "primary", "smg"}
weaponArray[131] = {"tfa_ins2_saiga_spike", "Spike X1S", "primary", "sniper"}
weaponArray[132] = {"tfa_ins2_sr25_eft", "SR-25", "primary", "rifle"}
weaponArray[133] = {"tfa_ins2_sr2m_veresk", "SR-2M", "primary", "smg"}
weaponArray[134] = {"tfa_doisten", "Sten", "primary", "smg"}
weaponArray[135] = {"tfa_nam_stevens620", "Stevens 620", "primary", "shotgun"}
weaponArray[136] = {"tfa_doistg44", "StG 44", "primary", "rifle"}
weaponArray[137] = {"tfa_ins2_sv98", "SV-98", "primary", "sniper"}
weaponArray[138] = {"tfa_ins2_warface_orsis_t5000", "T-5000", "primary", "sniper"}
weaponArray[139] = {"tfa_japanese_exclusive_tanto", "Tanto", "melee"}
weaponArray[140] = {"tfa_ins_sandstorm_tariq", "Tariq", "secondary", "pistol"}
weaponArray[141] = {"st_stim_pistol", "TCo Stim Pistol", "secondary", "pistol"}
weaponArray[142] = {"tfa_doithompsonm1928", "Thompson M1928", "primary", "smg"}
weaponArray[143] = {"tfa_doithompsonm1a1", "Thompson M1A1", "primary", "smg"}
weaponArray[144] = {"tfa_ins2_tridagger", "Tri-Dagger", "melee"}
weaponArray[145] = {"tfa_ins2_typhoon12", "Typhoon F12", "primary", "shotgun"}
weaponArray[146] = {"tfa_ins2_ump45", "UMP", "primary", "smg"}
weaponArray[147] = {"tfa_ins2_usp_match", "USP", "secondary", "pistol"}
weaponArray[148] = {"tfa_ins2_imi_uzi", "Uzi", "secondary", "smg"}
weaponArray[149] = {"tfa_ins2_vhsd2", "VHS-D2", "primary", "rifle"}
weaponArray[150] = {"tfa_ins2_wa2000", "WA-2000", "primary", "sniper"}
weaponArray[151] = {"tfa_ins2_walther_p99", "Walther P99", "secondary", "pistol"}
weaponArray[152] = {"tfa_doi_webley", "Webley", "secondary", "pistol"}
weaponArray[153] = {"tfa_ins2_xm8", "XM8", "primary", "rifle"}
