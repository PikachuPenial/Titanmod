...
weaponArray[20] = {"tfa_ins2_br99", "BR99", "primary", "shotgun"}
weaponArray[21] = {"tfa_doibren", "Bren", "primary", "lmg"}
weaponArray[22] = {"tfa_ins2_m4_9mm", "Colt 9mm", "primary", "smg"}
weaponArray[23] = {"rust_crossbow", "Crossbow", "primary", "sniper"}
weaponArray[24] = {"tfa_ins2_cz75", "CZ 75", "secondary", "pistol"}
weaponArray[25] = {"tfa_ins2_cz805", "CZ 805", "primary", "rifle"}
weaponArray[26] = {"tfa_ins2_deagle", "Desert Eagle", "secondary", "pistol"}
weaponArray[27] = {"tfa_ins2_warface_amp_dsr1", "DSR-50", "primary", "sniper"}
weaponArray[28] = {"tfa_dualmac", "Dual Mac 10s", "primary", "pistol"}
weaponArray[29] = {"tfa_l4d2_skorpion_dual", "Dual Skorpions", "primary", "pistol"}
weaponArray[30] = {"tfa_ins2_famas", "FAMAS", "primary", "rifle"}
weaponArray[31] = {"tfa_doifg42", "FG 42", "primary", "lmg"}
weaponArray[32] = {"tfa_ins2_fiveseven_eft", "Fiveseven", "secondary", "pistol"}
weaponArray[33] = {"tfa_ins2_fn_2000", "FN 2000", "primary", "rifle"}
weaponArray[34] = {"tfa_ins2_fn_fal", "FN FAL", "primary", "rifle"}
weaponArray[35] = {"tfa_ins2_fnp45", "FNP-45", "secondary", "pistol"}
weaponArray[36] = {"tfa_ins2_g28", "G28", "primary", "rifle"}
weaponArray[37] = {"tfa_ins2_g36a1", "G36A1", "primary", "rifle"}
weaponArray[38] = {"tfa_ins2_wpn_imigalilarm", "Galil", "primary", "rifle"}
weaponArray[39] = {"tfa_glk_gen4", "Glock 18", "secondary", "pistol"}
weaponArray[40] = {"grenade", "Grenade", "none", "explosive"} -- we have a grenade entry for kill tracking
weaponArray[41] = {"tfa_ins2_groza", "Groza", "primary", "rifle"}
weaponArray[42] = {"tfa_ins2_gsh18", "GSH-18", "secondary", "pistol"}
weaponArray[43] = {"tfa_ins2_fml_hk53", "HK53", "primary", "rifle"}
...
weaponArray[47] = {"tfa_ins2_warface_cheytac_m200", "Intervention", "primary", "sniper"}
weaponArray[48] = {"ryry_tfa_chainsaw", "KAC ChainSAW", "primary", "lmg"}
weaponArray[49] = {"tfa_doi_kar98k", "Kar98k", "primary", "sniper"}
weaponArray[50] = {"tfa_karambit", "Karambit", "melee"}
weaponArray[51] = {"tfa_km2000_knife", "KM-2000", "melee"}
weaponArray[52] = {"tfa_ins2_krissv", "KRISS Vector", "primary", "smg"}
weaponArray[53] = {"tfa_coldwar_ks23", "KS-23", "primary", "shotgun"}
weaponArray[54] = {"tfa_ins2_ksg", "KSG", "primary", "shotgun"}
weaponArray[55] = {"tfa_ins2_l85a2", "L85", "primary", "rifle"}
weaponArray[56] = {"tfa_doi_enfield", "Lee Enfield", "primary", "sniper"}
weaponArray[57] = {"tfa_doilewis", "Lewis Gun", "primary", "lmg"}
weaponArray[58] = {"tfa_ins2_zm_lr300", "LR-300", "primary", "rifle"}
weaponArray[59] = {"tfa_doi_garand", "M1 Garand", "primary", "rifle"}
weaponArray[60] = {"tfa_usurper", "M134 Minigun", "primary", "lmg"}
weaponArray[61] = {"tfa_ins2_m14retro", "M14", "primary", "rifle"}
weaponArray[62] = {"tfa_nam_m1911", "M1911", "secondary", "pistol"}
weaponArray[63] = {"tfa_doim1918", "M1918", "primary", "lmg"}
weaponArray[64] = {"tfa_doim1919", "M1919", "primary", "lmg"}
weaponArray[65] = {"tfa_ins2_minimi", "M249", "primary", "lmg"}
weaponArray[66] = {"tfa_doim3greasegun", "M3 Grease Gun", "secondary", "smg"}
weaponArray[67] = {"tfa_ins2_colt_m45", "M45A1", "secondary", "pistol"}
weaponArray[68] = {"tfa_ins2_eftm4a1", "M4A1", "primary", "rifle"}
weaponArray[69] = {"tfa_nam_m79", "M79", "primary", "explosive"}
weaponArray[70] = {"tfa_ins2_m9", "M9", "secondary", "pistol"}
weaponArray[71] = {"bocw_mac10_alt", "Mac 10", "secondary", "smg"}
weaponArray[72] = {"tfa_ararebo_bf1", "Mace", "melee"}
weaponArray[73] = {"tfa_ins2_pm", "Makarov", "secondary", "pistol"}
weaponArray[74] = {"tfa_tfre_maresleg", "Mare's Leg", "secondary", "pistol"}
weaponArray[75] = {"tfa_fml_lefrench_mas38", "Mas 38", "primary", "smg"}
weaponArray[76] = {"tfa_doimg34", "MG 34", "primary", "lmg"}
weaponArray[77] = {"tfa_doimg42", "MG 42", "primary", "lmg"}
weaponArray[78] = {"tfa_ins2_mk14ebr", "MK 14 EBR", "primary", "rifle"}
weaponArray[79] = {"tfa_ins2_mk23", "MK 23", "secondary", "pistol"}
weaponArray[80] = {"tfa_fml_inss_mk18", "MK18", "primary", "rifle"}
weaponArray[81] = {"tfa_ins2_swmodel10", "Model 10", "secondary", "pistol"}
weaponArray[82] = {"tfa_ins2_mosin_nagant", "Mosin Nagant", "primary", "sniper"}
weaponArray[83] = {"tfa_doimp40", "MP 40", "primary", "smg"}
weaponArray[84] = {"tfa_ins2_mp443", "MP-443", "secondary", "pistol"}
weaponArray[85] = {"tfa_ww1_mp18", "MP18", "primary", "smg"}
weaponArray[86] = {"tfa_inss2_hk_mp5a5", "MP5", "primary", "smg"}
weaponArray[87] = {"tfa_ins2_mp5k", "MP5K", "secondary", "smg"}
weaponArray[88] = {"tfa_ins2_mp7", "MP7", "primary", "smg"}
weaponArray[89] = {"tfa_ins2_warface_bt_mp9", "MP9", "primary", "smg"}
weaponArray[90] = {"tfa_jw_tti_mpx", "MPX", "primary", "smg"}
weaponArray[91] = {"tfa_ins2_mr96", "MR-96", "secondary", "pistol"}
weaponArray[92] = {"tfa_ins2_mc255", "MTs225", "primary", "shotgun"}
weaponArray[93] = {"tfa_bocw_nailgun", "Nailgun", "secondary", "pistol"}
weaponArray[94] = {"tfa_ins2_nova", "Nova", "primary", "shotgun"}
weaponArray[95] = {"tfa_l4d2_osp18", "OSP-18", "secondary", "pistol"}
weaponArray[96] = {"tfa_ins2_ots_33_pernach", "OTs-33 Pernach", "secondary", "pistol"}
weaponArray[97] = {"tfa_doiowen", "Owen Gun", "primary", "smg"}
weaponArray[98] = {"tfa_ins2_p320_m18", "P320", "secondary", "pistol"}
weaponArray[99] = {"tfa_fml_p90_tac", "P90", "primary", "smg"}
weaponArray[100] = {"tfa_blast_pindadss2", "Pindad SS2", "primary", "rifle"}
weaponArray[101] = {"tfa_ins2_pkp", "PKP", "primary", "lmg"}
weaponArray[102] = {"tfa_ins2_pm9", "PM-9", "secondary", "smg"}
weaponArray[103] = {"tfa_fas2_ppbizon", "PP-19 Bizon", "primary", "smg"}
weaponArray[104] = {"tfa_nam_ppsh41", "PPSH", "primary", "smg"}
weaponArray[105] = {"tfa_ww2_pbz39", "PzB 39", "primary", "sniper"}
weaponArray[106] = {"tfa_ins2_norinco_qbz97", "QBZ-97", "primary", "rifle"}
weaponArray[107] = {"tfa_ins2_qsz92", "QSZ-92", "secondary", "pistol"}
weaponArray[108] = {"tfa_ins2_remington_m870", "Remington M870", "primary", "shotgun"}
weaponArray[109] = {"tfa_ins2_pd2_remington_msr", "Remington MSR", "primary", "sniper"}
weaponArray[110] = {"tfa_ins2_rfb", "RFB", "primary", "rifle"}
weaponArray[111] = {"swat_shield", "Riot Shield", "secondary", "melee"}
weaponArray[112] = {"tfa_ins2_rpg7_scoped", "RPG-7", "primary", "explosive"}
weaponArray[113] = {"tfa_ins2_rpk_74m", "RPK-74M", "primary", "lmg"}
weaponArray[114] = {"tfa_ins2_s&w_500", "S&W 500", "secondary", "pistol"}
weaponArray[115] = {"tfa_ins2_izh43sw", "Sawed Off", "secondary", "shotgun"}
weaponArray[116] = {"tfa_ins2_scar_h_ssr", "SCAR-H", "primary", "rifle"}
weaponArray[117] = {"tfa_ins2_sc_evo", "Scorpion Evo", "primary", "smg"}
weaponArray[118] = {"tfa_l4d2_skorpion", "Skorpion", "secondary", "pistol"}
weaponArray[119] = {"tfa_ins2_sks", "SKS", "primary", "rifle"}
weaponArray[120] = {"tfa_ins2_spas12", "SPAS-12", "primary", "shotgun"}
weaponArray[121] = {"tfa_ins2_spectre", "Spectre M4", "primary", "smg"}
weaponArray[122] = {"tfa_ins2_saiga_spike", "Spike X1S", "primary", "sniper"}
weaponArray[123] = {"tfa_ins2_sr25_eft", "SR-25", "primary", "rifle"}
weaponArray[124] = {"tfa_ins2_sr2m_veresk", "SR-2M", "primary", "smg"}
weaponArray[125] = {"tfa_doisten", "Sten", "primary", "smg"}
weaponArray[126] = {"tfa_nam_stevens620", "Stevens 620", "primary", "shotgun"}
weaponArray[127] = {"tfa_doistg44", "StG 44", "primary", "rifle"}
weaponArray[128] = {"tfa_ins2_sv98", "SV-98", "primary", "sniper"}
weaponArray[129] = {"tfa_ins2_warface_orsis_t5000", "T-5000", "primary", "sniper"}
weaponArray[130] = {"tfa_japanese_exclusive_tanto", "Tanto", "melee"}
weaponArray[131] = {"tfa_ins_sandstorm_tariq", "Tariq", "secondary", "pistol"}
weaponArray[132] = {"st_stim_pistol", "TCo Stim Pistol", "secondary", "pistol"}
weaponArray[133] = {"tfa_doithompsonm1928", "Thompson M1928", "primary", "smg"}
weaponArray[134] = {"tfa_doithompsonm1a1", "Thompson M1A1", "primary", "smg"}
weaponArray[135] = {"tfa_ins2_typhoon12", "Typhoon F12", "primary", "shotgun"}
weaponArray[136] = {"tfa_ins2_ump45", "UMP", "primary", "smg"}
weaponArray[137] = {"tfa_ins2_usp_match", "USP", "secondary", "pistol"}
weaponArray[138] = {"tfa_ins2_imi_uzi", "Uzi", "secondary", "smg"}
weaponArray[139] = {"tfa_ins2_vhsd2", "VHS-D2", "primary", "rifle"}
weaponArray[140] = {"tfa_ins2_wa2000", "WA-2000", "primary", "sniper"}
weaponArray[141] = {"tfa_ins2_walther_p99", "Walther P99", "secondary", "pistol"}
weaponArray[142] = {"tfa_doi_webley", "Webley", "secondary", "pistol"}
weaponArray[143] = {"tfa_ins2_xm8", "XM8", "primary", "rifle"}
