...
function PlayerHUDReset(ply, cmd, args)
	...
	RunConsoleCommand("tm_hud_fpscounter_x", 10)
	RunConsoleCommand("tm_hud_fpscounter_y", 5)
	RunConsoleCommand("tm_hud_fpscounter_r", 255)
	RunConsoleCommand("tm_hud_fpscounter_g", 255)
	RunConsoleCommand("tm_hud_fpscounter_b", 255)
