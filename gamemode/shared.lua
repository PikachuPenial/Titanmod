...
modelArray[21] = {"models/paynamia/bms/gordon_survivor_player.mdl", "Gordon", "headshot", 125}
modelArray[22] = {"models/munch/mace/Mace.mdl", "Mace", "headshot", 250}
modelArray[23] = {"models/player/darky_m/rust/arctic_hazmat.mdl", "Arctic", "headshot", 450}
modelArray[24] = {"models/player/eft/shturman/eft_shturman/models/eft_shturman_pm.mdl", "Shturman", "headshot", 900}
modelArray[25] = {"models/player/darky_m/rust/scientist.mdl", "Cobalt", "smackdown", 40}
modelArray[26] = {"models/Splinks/Hotline_Miami/Jacket/Player_jacket.mdl", "Jacket", "smackdown", 80}
modelArray[27] = {"models/titanfall2_playermodel/kanepm.mdl", "Kane", "smackdown", 160}
modelArray[28] = {"models/auditor/r6s/707/vigil/chr_707_vigil.mdl", "Vigil", "smackdown", 320}
modelArray[29] = {"models/player/combine_super_soldier.mdl", "Super Soilder", "clutch", 30}
modelArray[30] = {"models/patrickbateman/Playermodels/patrickbateman.mdl", "Bateman", "clutch", 60}
modelArray[31] = {"models/player/darky_m/rust/spacesuit.mdl", "Spacesuit", "clutch", 150}
modelArray[32] = {"models/us_airforce/jetpilot_usaf.mdl", "Pilot", "clutch", 300}
modelArray[33] = {"models/player/john_marston.mdl", "Martson", "longshot", 30}
modelArray[34] = {"models/player/darky_m/rust/hazmat.mdl", "Hazmat", "longshot", 60}
modelArray[35] = {"models/player/darky_m/rust/nomad.mdl", "Nomad", "longshot", 150}
modelArray[36] = {"models/arachnit/csgonewsas/ctm_sasplayerwinter.mdl", "Winter SAS", "longshot", 300}
modelArray[37] = {"models/maxpayne3/ufe/ufepm.mdl", "UFE", "pointblank", 120}
modelArray[38] = {"models/starwarsbf1/Scoutrooper.mdl", "Scout", "pointblank", 240}
modelArray[39] = {"models/kyo/ghot.mdl", "Ghost", "pointblank", 480}
modelArray[40] = {"models/arachnit/csgonewsas/ctm_sasplayer.mdl", "SAS", "pointblank", 720}
modelArray[41] = {"models/Krueger_PlayerModel/Zaper/Krueger_Body.mdl", "Krueger", "killstreaks", 80}
modelArray[42] = {"models/player/tabspeasant.mdl", "Wobbler", "killstreaks", 160}
modelArray[43] = {"models/captainbigbutt/vocaloid/miku_classic.mdl", "Miku", "killstreaks", 320}
modelArray[44] = {"models/theboys/homelander.mdl", "Homelander", "killstreaks", 480}
modelArray[45] = {"models/player/voikanaa/snoop_dogg.mdl", "Snoop", "buzzkills", 60}
modelArray[46] = {"models/pacagma/humans/heroes/imc_hero_viper_player.mdl", "Viper", "buzzkills", 120}
modelArray[47] = {"models/auditor/titanfall2/cooper/chr_jackcooper.mdl", "Cooper", "buzzkills", 200}
modelArray[48] = {"models/auditor/re2/chr_hunk_pmrig.mdl", "Hunk", "buzzkills", 320}
...
cardArray[87] = {"cards/mastery/auga2.png", "Lightning", "AUG A2 mastery", "mastery", "tfa_fml_csgo_aug"}
cardArray[88] = {"cards/mastery/awm.png", "Dust II", "AWM mastery", "mastery", "tfa_cod_accuracy_international_l115a3"}
cardArray[89] = {"cards/mastery/ax308.png", "Range", "AX-308 mastery", "mastery", "tfa_ins2_warface_ax308"}
cardArray[90] = {"cards/mastery/barrettm98b.png", "Ready", "Barrett M98B mastery", "mastery", "tfa_ins2_barrett_m98_bravo"}
cardArray[91] = {"cards/mastery/berettamx4.png", "House", "Barrett Mx4 mastery", "mastery", "tfa_ins2_mx4"}
cardArray[92] = {"cards/mastery/bow.png", "Cargo Ship", "Bow mastery", "mastery", "rust_bow"}
cardArray[93] = {"cards/mastery/br99.png", "Rouge", "BR99 mastery", "mastery", "tfa_ins2_br99"}
cardArray[94] = {"cards/mastery/bren.png", "Flank", "Bren mastery", "mastery", "tfa_doibren"}
cardArray[95] = {"cards/mastery/colt9mm.png", "Magazines", "Colt 9mm mastery", "mastery", "tfa_ins2_m4_9mm"}
cardArray[96] = {"cards/mastery/crossbow.png", "Arrows", "Crossbow mastery", "mastery", "rust_crossbow"}
cardArray[97] = {"cards/mastery/cz75.png", "Nuke", "CZ 75 mastery", "mastery", "tfa_ins2_cz75"}
cardArray[98] = {"cards/mastery/cz805.png", "Showcase", "CZ 805 mastery", "mastery", "tfa_ins2_cz805"}
cardArray[99] = {"cards/mastery/deserteagle.png", "Mag Check", "Desert Eagle mastery", "mastery", "tfa_ins2_deagle"}
cardArray[100] = {"cards/mastery/dsr50.png", "Arena", "DSR-50 mastery", "mastery", "tfa_ins2_warface_amp_dsr1"}
cardArray[101] = {"cards/mastery/dualskorpion.png", "Celestial", "Dual Skorpions mastery", "mastery", "tfa_l4d2_skorpion_dual"}
cardArray[102] = {"cards/mastery/famas.png", "Siege", "Famas mastery", "mastery", "tfa_ins2_famas"}
cardArray[103] = {"cards/mastery/fg42.png", "Glint", "FG 42 mastery", "mastery", "tfa_doifg42"}
cardArray[104] = {"cards/mastery/fiveseven.png", "Galactic", "Fiveseven mastery", "mastery", "tfa_ins2_fiveseven_eft"}
cardArray[105] = {"cards/mastery/fn2000.png", "Armory", "FN 2000 mastery", "mastery", "tfa_ins2_fn_2000"}
cardArray[106] = {"cards/mastery/fnfal.png", "Exposed", "FN FAL mastery", "mastery", "tfa_ins2_fn_fal"}
cardArray[107] = {"cards/mastery/fnp45.png", "ACP", "FNP-45 mastery", "mastery", "tfa_ins2_fnp45"}
cardArray[108] = {"cards/mastery/g28.png", "Legacy", "G28 mastery", "mastery", "tfa_ins2_g28"}
cardArray[109] = {"cards/mastery/g36a1.png", "Aimpoint", "G36A1 mastery", "mastery", "tfa_ins2_g36a1"}
cardArray[110] = {"cards/mastery/glock18.png", "Ospery", "Glock 18 mastery", "mastery", "tfa_glk_gen4"}
cardArray[111] = {"cards/mastery/grenade.png", "Quasar", "Grenade mastery", "mastery", "grenade"}
cardArray[112] = {"cards/mastery/groza.png", "Bullpup", "Groza mastery", "mastery", "tfa_ins2_groza"}
cardArray[113] = {"cards/mastery/gsh18.png", "Skyscraper", "GSH-18 mastery", "mastery", "tfa_ins2_gsh18"}
cardArray[114] = {"cards/mastery/hk53.png", "Chains", "HK53 mastery", "mastery", "tfa_ins2_fml_hk53"}
cardArray[115] = {"cards/mastery/honeybadger.png", "Business", "Honey Badger mastery", "mastery", "tfa_ins2_cq300"}
cardArray[116] = {"cards/mastery/howatype64.png", "Cradle", "Howa Type 64 mastery", "mastery", "tfa_howa_type_64"}
cardArray[117] = {"cards/mastery/imbelia2.png", "Process", "Imbel IA2 mastery", "mastery", "tfa_ins2_imbelia2"}
cardArray[118] = {"cards/mastery/intervention.png", "Trickshot", "Intervention mastery", "mastery", "tfa_ins2_warface_cheytac_m200"}
cardArray[119] = {"cards/mastery/kacchainsaw.png", "Scare", "KAC ChainSAW mastery", "mastery", "ryry_tfa_chainsaw"}
cardArray[120] = {"cards/mastery/km2000.png", "Flatgrass", "KM-2000 mastery", "mastery", "tfa_km2000_knife"}
cardArray[121] = {"cards/mastery/krissvector.png", "Narkotica", "KRISS Vector mastery", "mastery", "tfa_ins2_krissv"}
cardArray[122] = {"cards/mastery/ksg.png", "Flames", "KSG mastery", "mastery", "tfa_ins2_ksg"}
cardArray[123] = {"cards/mastery/leeenfield.png", "Minecraft", "Lee Enfield master", "mastery", "tfa_doi_enfield"}
cardArray[124] = {"cards/mastery/lewis.png", "Big Bang", "Lewis mastery", "mastery", "tfa_doilewis"}
cardArray[125] = {"cards/mastery/lr300.png", "Oil Rig", "LR-300 mastery", "mastery", "tfa_ins2_zm_lr300"}
cardArray[126] = {"cards/mastery/m1garand.png", "Underworld", "M1 Garand mastery", "mastery", "tfa_doi_garand"}
cardArray[127] = {"cards/mastery/m14.png", "Bridge", "M14 mastery", "mastery", "tfa_ins2_m14retro"}
cardArray[128] = {"cards/mastery/m1911.png", "Relic", "M1911 mastery", "mastery", "tfa_nam_m1911"}
cardArray[129] = {"cards/mastery/m1918.png", "Bipod", "M1918 mastery", "mastery", "tfa_doim1918"}
cardArray[130] = {"cards/mastery/m1919.png", "Customs", "M1919 mastery", "mastery", "tfa_doim1919"}
cardArray[131] = {"cards/mastery/m249.png", "Camper", "M249 mastery", "mastery", "tfa_ins2_minimi"}
cardArray[132] = {"cards/mastery/m3grease.png", "Grease", "M3 Grease Gun mastery", "mastery", "tfa_doim3greasegun"}
cardArray[133] = {"cards/mastery/m45a1.png", "Legend", "M45A1 mastery", "mastery", "tfa_ins2_colt_m45"}
cardArray[134] = {"cards/mastery/m4a1.png", "Smug", "M4A1 mastery", "mastery", "tfa_ins2_eftm4a1"}
cardArray[135] = {"cards/mastery/m79.png", "Cool With It", "M79 mastery", "mastery", "tfa_nam_m79"}
cardArray[136] = {"cards/mastery/m9.png", "Full Metal", "M9 mastery", "mastery", "tfa_ins2_m9"}
cardArray[137] = {"cards/mastery/mac10.png", "Dev", "Mac 10 mastery", "mastery", "bocw_mac10_alt"}
cardArray[138] = {"cards/mastery/mace.png", "Industry", "Mace master", "mastery", "tfa_ararebo_bf1"}
cardArray[139] = {"cards/mastery/makarov.png", "Leaves", "Makarov mastery", "mastery", "tfa_ins2_pm"}
cardArray[140] = {"cards/mastery/maresleg.png", "High Optic", "Mare's Leg mastery", "mastery", "tfa_tfre_maresleg"}
cardArray[141] = {"cards/mastery/mas38.png", "Galaxy", "Mas 38 mastery", "mastery", "tfa_fml_lefrench_mas38"}
cardArray[142] = {"cards/mastery/mg34.png", "Heavy ", "MG 34 mastery", "mastery", "tfa_doimg34"}
cardArray[143] = {"cards/mastery/mg42.png", "D-Day", "MG 42 mastery", "mastery", "tfa_doimg42"}
cardArray[144] = {"cards/mastery/mk14ebr.png", "Prepared", "MK 14 EBR mastery", "mastery", "tfa_ins2_mk14ebr"}
cardArray[145] = {"cards/mastery/mk23.png", "Uranium", "MK 23 mastery", "mastery", "tfa_ins2_mk23"}
cardArray[146] = {"cards/mastery/mk18.png", "Waster", "MK18 mastery", "mastery", "tfa_fml_inss_mk18"}
cardArray[147] = {"cards/mastery/model10.png", "Walter", "Model 10 mastery", "mastery", "tfa_ins2_swmodel10"}
cardArray[148] = {"cards/mastery/mosin.png", "Rebirth", "Mosin Nagant mastery", "mastery", "tfa_ins2_mosin_nagant"}
cardArray[149] = {"cards/mastery/mp40.png", "Reflection", "MP 40 mastery", "mastery", "tfa_doimp40"}
cardArray[150] = {"cards/mastery/mp443.png", "Bush", "MP-443 mastery", "mastery", "tfa_ins2_mp443"}
cardArray[151] = {"cards/mastery/mp18.png", "Modern", "MP18 mastery", "mastery", "tfa_ww1_mp18"}
cardArray[152] = {"cards/mastery/mp5.png", "Select", "MP5 mastery", "mastery", "tfa_inss2_hk_mp5a5"}
cardArray[153] = {"cards/mastery/mp5k.png", "H&K", "MP5K mastery", "mastery", "tfa_ins2_mp5k"}
cardArray[154] = {"cards/mastery/mp7.png", "Oilspill", "MP7 mastery", "mastery", "tfa_ins2_mp7"}
cardArray[155] = {"cards/mastery/mp9.png", "Training", "MP9 mastery", "mastery", "tfa_ins2_warface_bt_mp9"}
cardArray[156] = {"cards/mastery/mr96.png", "Polish", "MR-96 mastery", "mastery", "tfa_ins2_mr96"}
cardArray[157] = {"cards/mastery/mts225.png", "Slug", "MTs225 mastery", "mastery", "tfa_ins2_mc255"}
cardArray[158] = {"cards/mastery/nova.png", "Dark Street", "Nova mastery", "mastery", "tfa_ins2_nova"}
cardArray[159] = {"cards/mastery/osp18.png", "Irons", "OSP-18 mastery", "mastery", "tfa_l4d2_osp18"}
cardArray[160] = {"cards/mastery/otspernach.png", "Speedloader", "OTs-33 Pernach mastery", "mastery", "tfa_ins2_ots_33_pernach"}
cardArray[161] = {"cards/mastery/owenmki.png", "Grid", "Owen Gun mastery", "mastery", "tfa_doiowen"}
cardArray[162] = {"cards/mastery/p320.png", "Sauer", "P320 mastery", "mastery", "tfa_ins2_p320_m18"}
cardArray[163] = {"cards/mastery/p90.png", "MISSING", "P90 mastery", "mastery", "tfa_fml_p90_tac"}
cardArray[164] = {"cards/mastery/pindad.png", "Labs", "Pindad SS2 mastery", "mastery", "tfa_blast_pindadss2"}
cardArray[165] = {"cards/mastery/pkp.png", "Royalty", "PKP mastery", "mastery", "tfa_ins2_pkp"}
cardArray[166] = {"cards/mastery/pm9.png", "Akimbo", "PM-9 mastery", "mastery", "tfa_ins2_pm9"}
cardArray[167] = {"cards/mastery/ppbizon.png", "Rainbow", "PP-19 Bizon mastery", "mastery", "tfa_fas2_ppbizon"}
cardArray[168] = {"cards/mastery/ppsh.png", "Mephitic", "PPSH mastery", "mastery", "tfa_nam_ppsh41"}
cardArray[169] = {"cards/mastery/pzb39.png", "Exotic", "PzB 39 mastery", "mastery", "tfa_ww2_pbz39"}
cardArray[170] = {"cards/mastery/qbz97.png", "Hideout", "QBZ-97 mastery", "mastery", "tfa_ins2_norinco_qbz97"}
cardArray[171] = {"cards/mastery/qsz92.png", "yippee", "QSZ-92 mastery", "mastery", "tfa_ins2_qsz92"}
cardArray[172] = {"cards/mastery/remingtonm870.png", "Code", "Remington M870 master", "mastery", "tfa_ins2_remington_m870"}
cardArray[173] = {"cards/mastery/remingtonmsr.png", "Lightshow", "Remington MSR mastery", "mastery", "tfa_ins2_pd2_remington_msr"}
cardArray[174] = {"cards/mastery/rfb.png", "Extraction", "RFB mastery", "mastery", "tfa_ins2_rfb"}
cardArray[175] = {"cards/mastery/rpg7.png", "Damascus", "RPG-7 mastery", "mastery", "tfa_ins2_rpg7_scoped"}
cardArray[176] = {"cards/mastery/rpk74m.png", "Elcan", "RPK-74M mastery", "mastery", "tfa_ins2_rpk_74m"}
cardArray[177] = {"cards/mastery/sw500.png", "Companion", "S&W 500 mastery", "mastery", "tfa_ins2_s&w_500"}
cardArray[178] = {"cards/mastery/sa80.png", "Groves", "SA80 mastery", "mastery", "tfa_ins2_l85a2"}
cardArray[179] = {"cards/mastery/sawedoff.png", "Halves", "Sawed Off mastery", "mastery", "tfa_ins2_izh43sw"}
cardArray[180] = {"cards/mastery/scarh.png", "Tilted", "SCAR-H mastery", "mastery", "tfa_ins2_scar_h_ssr"}
cardArray[181] = {"cards/mastery/scorpionevo.png", "Raid", "Scorpion Evo mastery", "mastery", "tfa_ins2_sc_evo"}
cardArray[182] = {"cards/mastery/skorpion.png", "Black Hole", "Skorpion mastery", "mastery", "tfa_l4d2_skorpion"}
cardArray[183] = {"cards/mastery/sks.png", "Scav", "SKS mastery", "mastery", "tfa_ins2_sks"}
cardArray[184] = {"cards/mastery/spas.png", "12 Gauge", "SPAS-12 mastery", "mastery", "tfa_ins2_spas12"}
cardArray[185] = {"cards/mastery/spectrem4.png", "Mall", "Spectre M4 mastery", "mastery", "tfa_ins2_spectre"}
cardArray[186] = {"cards/mastery/spikex1s.png", "Prototype", "Spike X1S mastery", "mastery", "tfa_ins2_saiga_spike"}
cardArray[187] = {"cards/mastery/sr2m.png", "Blueprint", "SR-2M mastery", "mastery", "tfa_ins2_sr2m_veresk"}
cardArray[188] = {"cards/mastery/sten.png", "Lens Flare", "Sten Gun mastery", "mastery", "tfa_doisten"}
cardArray[189] = {"cards/mastery/stevens620.png", "Mod", "Stevens 620 mastery", "mastery", "tfa_nam_stevens620"}
cardArray[190] = {"cards/mastery/stg44.png", "Wood", "StG 44 mastery", "mastery", "tfa_doistg44"}
cardArray[191] = {"cards/mastery/sv98.png", "Vertigo", "SV-98 mastery", "mastery", "tfa_ins2_sv98"}
cardArray[192] = {"cards/mastery/t5000.png", "Reserve", "T-5000 mastery", "mastery", "tfa_ins2_warface_orsis_t5000"}
cardArray[193] = {"cards/mastery/tanto.png", "Shipment", "Tanto mastery", "mastery", "tfa_japanese_exclusive_tanto"}
cardArray[194] = {"cards/mastery/tariq.png", "Dog", "Tariq mastery", "mastery", "tfa_ins_sandstorm_tariq"}
cardArray[195] = {"cards/mastery/thompsonm1928.png", "Typewritter", "Thompson M1928 master", "mastery", "tfa_doithompsonm1928"}
cardArray[196] = {"cards/mastery/thompson.png", "Depression", "Thompson M1A1 master", "mastery", "tfa_doithompsonm1a1"}
cardArray[197] = {"cards/mastery/typhoonf12.png", "Ultrakill", "Typhoon F12 mastery", "mastery", "tfa_ins2_typhoon12"}
cardArray[198] = {"cards/mastery/ump45.png", "Nuketown", "UMP .45 mastery", "mastery", "tfa_ins2_ump45"}
cardArray[199] = {"cards/mastery/ump9.png", "Waterfall", "UMP9 mastery", "mastery", "tfa_ins2_ump9"}
cardArray[200] = {"cards/mastery/usp.png", "Strike", "USP mastery", "mastery", "tfa_ins2_usp_match"}
cardArray[201] = {"cards/mastery/uzi.png", "Alpha", "Uzi mastery", "mastery", "tfa_ins2_imi_uzi"}
cardArray[202] = {"cards/mastery/vhsd2.png", "Liminal", "VHS-D2 mastery", "mastery", "tfa_ins2_vhsd2"}
cardArray[203] = {"cards/mastery/waltherp99.png", "Advisory", "Walther P99 mastery", "mastery", "tfa_ins2_walther_p99"}
cardArray[204] = {"cards/mastery/webley.png", "Bear", "Webley mastery", "mastery", "tfa_doi_webley"}
