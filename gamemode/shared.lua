...
function GM:Initialize()
    ...
    weaponArray[56] = {"tfa_ins2_krissv", "KRISS Vector"}
    ...
    weaponArray[112] = {"tfa_blast_pindadss2", "PINDAD SS2-V1"}
    weaponArray[113] = {"tfa_ins2_acrc", "ACR-C"}
    weaponArray[114] = {"tfa_blast_lynx_msbsb", "FB MSBS-B"}
    weaponArray[115] = {"fres_grapple", "Grappling Hook"}
    weaponArray[116] = {"st_stim_pistol", "TCo Stim Pistol"}
    weaponArray[117] = {"tfa_blast_ksvk_cqb", "KSVK 12.7"}
    weaponArray[118] = {"tfa_ins2_ump9", "UMP9"}
    weaponArray[119] = {"tfa_ins2_type81", "Type 81"}
