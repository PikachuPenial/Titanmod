...
if CLIENT then
    ...
    CreateClientConVar("tm_clantag_color_r", 255, true, true, "Adjusts the red coloring of the players clan tag.", 0, 255)
    CreateClientConVar("tm_clantag_color_g", 255, true, true, "Adjusts the green coloring of the players clan tag.", 0, 255)
    CreateClientConVar("tm_clantag_color_b", 255, true, true, "Adjusts the blue coloring of the players clan tag.", 0, 255)
