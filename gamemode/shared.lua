...
if CLIENT then
    ...
    CreateClientConVar("tm_slidecanceltype", 0, true, true, "Determines the keybind that will cancel a slide", 0, 1)
    ...
    CreateClientConVar("tm_hud_crosshair_outline", 1, true, false, "Enable/disable the crosshair outline", 0, 1)
    CreateClientConVar("tm_hud_crosshair_opacity", 255, true, false, "Adjusts the crosshair opacity", 0, 255)
    CreateClientConVar("tm_hud_crosshair_color_r", 0, true, false, "Adjusts the red coloring for the crosshair", 0, 255)
    CreateClientConVar("tm_hud_crosshair_color_g", 255, true, false, "Adjusts the green coloring for the crosshair", 0, 255)
    CreateClientConVar("tm_hud_crosshair_color_b", 0, true, false, "Adjusts the blue coloring for the crosshair", 0, 255)
    ...
    CreateClientConVar("tm_hud_crosshair_show_ads", 0, true, false, "Enable/disable the crosshair while aiming down sights", 0, 1)
end
