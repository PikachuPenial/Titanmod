...
if CLIENT then
    ...
    CreateClientConVar("tm_clantag", "", true, true, "Sets the players clan tag.")
...
cardArray[49] = {"cards/mastery/auga3.png", "Cute", "AUG A3 mastery", "mastery", "tfa_inss_aug"}
...
cardArray[94] = {"cards/mastery/m4a1.png", "Modified", "M4A1 mastery", "mastery", "tfa_ins2_eftm4a1"}
