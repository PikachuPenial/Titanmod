...
local function MatchStartPopup(ply)
    ...
    GamemodePopup:SizeTo(TM.HUDScale(-1), popupH - TM.HUDScale(8), 1, 0, 0.1)
...
net.Receive("SendNotification", function(len, ply)
    ...
    Notif:SizeTo(textLength + TM.HUDScale(64),TM.HUDScale(-1), 1, 0, 0.1)
    Notif:SetY(notis["y"])
    Notif:SetTitle("")
    ...
    timer.Create("removeNotification", 6.5, 1, function()
        Notif:SizeTo(TM.HUDScale(-1), 0, 0.75, 0, 0.1, function()
            Notif:Remove()
        end)
    end)
end )
