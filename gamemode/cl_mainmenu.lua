    ...
    if not IsValid(MainMenu) then
        ...
        local MainPanel = MainMenu:Add("MainPanel")
            ...
            Patch06b1.Paint = function(self, w, h)
                ...
                draw.SimpleText("   Scoreboard improvments", "StreakText", 5, 100, Color(250, 250, 250, 255), TEXT_ALIGN_LEFT)
                draw.SimpleText("   Suicides no longer give accolades", "StreakText", 5, 120, Color(250, 250, 250, 255), TEXT_ALIGN_LEFT)
                draw.SimpleText("   Fixed Firing Range appearing in map vote", "StreakText", 5, 140, Color(250, 250, 250, 255), TEXT_ALIGN_LEFT)
                draw.SimpleText("   Various efforts towards optimization", "StreakText", 5, 160, Color(250, 250, 250, 255), TEXT_ALIGN_LEFT)
            end
