...
weaponArray[12] = {"tfa_blast_ash12", "ASh-12", "primary", "12.7x55"}
...
weaponArray[28] = {"tfa_l4d2_skorpion_dual", "Dual Skorpions", "primary", "9x18"}
weaponArray[29] = {"tfa_ins2_famas", "Famas F1", "primary", "5.56x45"}
weaponArray[30] = {"tfa_blast_lynx_msbsb", "FB MSBS-B", "primary", "5.56x45"}
weaponArray[31] = {"tfa_doifg42", "FG 42", "primary", "7.92x57"}
weaponArray[32] = {"tfa_ins2_fiveseven_eft", "Fiveseven", "secondary", "5.7x28"}
weaponArray[33] = {"tfa_ins2_fn_2000", "FN 2000", "primary", "5.56x45"}
weaponArray[34] = {"tfa_ins2_fn_fal", "FN FAL", "primary", "7.62x51"}
...
weaponArray[46] = {"tfa_ins2_izh43sw", "IZH-43 Sawed Off", "secondary", "12 Gauge"}
weaponArray[47] = {"tfa_ararebo_bf1", "Japanese Ararebo", "melee"}
weaponArray[48] = {"tfa_km2000_knife", "KM-2000", "melee"}
weaponArray[49] = {"tfa_ins2_krissv", "KRISS Vector", "primary", ".45 ACP"}
weaponArray[50] = {"tfa_ins2_ksg", "KSG", "primary", "12 Gauge"}
weaponArray[51] = {"tfa_blast_ksvk_cqb", "KSVK 12.7", "primary", "12.7x108"}
weaponArray[52] = {"tfa_doi_enfield", "Lee-Enfield No. 4", "primary", ".303 Mk VII"}
weaponArray[53] = {"tfa_doilewis", "Lewis", "primary", ".303 British"}
weaponArray[54] = {"tfa_ins2_zm_lr300", "LR-300", "primary", "5.56x45"}
weaponArray[55] = {"tfa_doi_garand", "M1 Garand", "primary", ".30-06"}
weaponArray[56] = {"tfa_doim3greasegun", "M3 Grease Gun", "secondary", ".45 ACP"}
...
weaponArray[63] = {"tfa_inss_makarov", "Makarov", "secondary", "9x18"}
...
weaponArray[68] = {"tfa_ins2_minimi", "Minimi Para", "primary", "5.56x45"}
...
weaponArray[82] = {"tfa_ins2_warface_orsis_t5000", "Orsis T-5000", "primary", "6.5x47"}
weaponArray[83] = {"tfa_l4d2_osp18", "OSP-18", "secondary", ".45 ACP"}
weaponArray[84] = {"tfa_ins2_groza", "OTs-14 Groza", "primary", "7.62x39"}
weaponArray[85] = {"tfa_ins2_ots_33_pernach", "OTs-33 Pernach", "secondary", "9x18"}
weaponArray[86] = {"tfa_doiowen", "Owen Mk.I", "primary", "9x19"}
weaponArray[87] = {"tfa_fml_p90_tac", "P90", "primary", "5.7x28"}
weaponArray[88] = {"tfa_blast_pindadss2", "PINDAD SS2-V1", "primary", "5.56x45"}
weaponArray[89] = {"tfa_ins2_pm9", "PM-9", "primary", "9x19"}
weaponArray[90] = {"tfa_nam_ppsh41", "PPSH-41", "primary", "7.62x25"}
weaponArray[91] = {"tfa_fas2_ppbizon", "PP-19 Bizon", "primary", "9x18"}
weaponArray[92] = {"tfa_ww2_pbz39", "PzB 39", "primary", "7.92x94"}
weaponArray[93] = {"tfa_ins2_norinco_qbz97", "QBZ-97", "primary", "5.8x42"}
weaponArray[94] = {"tfa_ins2_qsz92", "QSZ-92", "secondary", "5.8x21"}
weaponArray[95] = {"tfa_ins2_remington_m870", "Remington M870", "primary", "12 Gauge"}
weaponArray[96] = {"tfa_ins2_pd2_remington_msr", "Remington MSR", "primary", ".338 Lapua"}
weaponArray[97] = {"tfa_ins2_rfb", "RFB", "primary", "7.62x51"}
weaponArray[98] = {"tfa_fml_rk62", "RK62", "primary", "7.62x39"}
weaponArray[99] = {"tfa_ins2_rpg7_scoped", "RPG-7", "primary", "40mm Rocket"}
weaponArray[100] = {"tfa_ins2_rpk_74m", "RPK-74M", "primary", "5.45x39"}
weaponArray[101] = {"tfa_ins2_l85a2", "SA80", "primary", "5.56x45"}
weaponArray[102] = {"tfa_ins2_scar_h_ssr", "SCAR-H", "primary", "5.56x45"}
weaponArray[103] = {"tfa_ins2_sc_evo", "Scorpion Evo", "primary", "9x19"}
weaponArray[104] = {"tfa_new_p226", "SIG P226", "secondary", "9x19"}
weaponArray[105] = {"tfa_l4d2_skorpion", "Skorpion", "secondary", "9x18"}
weaponArray[106] = {"tfa_ins2_sks", "SKS", "primary", "7.62x39"}
weaponArray[107] = {"tfa_ins2_spas12", "SPAS-12", "primary", "12 Gauge"}
weaponArray[108] = {"tfa_ins2_spectre", "Spectre M4", "primary", "9x19"}
weaponArray[109] = {"tfa_ins2_saiga_spike", "Spike X15", "primary", "12 Gauge"}
weaponArray[110] = {"tfa_ins2_sr2m_veresk", "SR-2M Veresk", "primary", "9x21"}
weaponArray[111] = {"tfa_doisten", "Sten Mk.II", "primary", "9x19"}
weaponArray[112] = {"tfa_nam_stevens620", "Stevens 620", "primary", "12 Gauge"}
weaponArray[113] = {"tfa_inss_aug", "Steyr AUG", "primary", "5.56x45"}
weaponArray[114] = {"tfa_doistg44", "StG44", "primary", "7.92x33"}
weaponArray[115] = {"tfa_ins2_sv98", "SV-98", "primary", "7.62x54"}
weaponArray[116] = {"tfa_ins2_s&w_500", "S&W 500", "secondary", ".500 Magnum"}
weaponArray[117] = {"tfa_japanese_exclusive_tanto", "Tanto", "melee"}
weaponArray[118] = {"tfa_ins_sandstorm_tariq", "Tariq", "secondary", "9x19"}
weaponArray[119] = {"st_stim_pistol", "TCo Stim Pistol", "secondary", "Syringe"}
weaponArray[120] = {"tfa_doithompsonm1928", "Thompson M1928", "primary", ".45 ACP"}
weaponArray[121] = {"tfa_doithompsonm1a1", "Thompson M1A1", "primary", ".45 ACP"}
weaponArray[122] = {"tfa_ins2_type81", "Type 81", "primary", "7.62x39"}
weaponArray[123] = {"tfa_ins2_typhoon12", "Typhoon F12", "primary", "12 Gauge"}
weaponArray[124] = {"tfa_ins2_ump45", "UMP .45", "primary", ".45 ACP"}
weaponArray[125] = {"tfa_ins2_ump9", "UMP9", "primary", "9x19"}
weaponArray[126] = {"tfa_ins2_imi_uzi", "Uzi", "secondary", ".22 LR"}
weaponArray[127] = {"tfa_ins2_br99", "UZK-BR99", "primary", "12 Gauge"}
weaponArray[128] = {"tfa_ins2_vhsd2", "VHS-D2", "primary", "5.56x45"}
weaponArray[129] = {"tfa_ins2_walther_p99", "Walther P99", "secondary", "9x19"}
weaponArray[130] = {"tfa_ins2_xm8", "XM8", "primary", "5.56x45"}
