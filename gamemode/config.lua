...
weaponArray[83] = {"tfa_ins2_mr96", "MR-96", "secondary", "pistol"}
weaponArray[84] = {"tfa_ins2_mc255", "MTs225", "primary", "shotgun"}
weaponArray[85] = {"tfa_ins2_nova", "Nova", "primary", "shotgun"}
weaponArray[86] = {"tfa_l4d2_osp18", "OSP-18", "secondary", "pistol"}
weaponArray[87] = {"tfa_ins2_ots_33_pernach", "OTs-33 Pernach", "secondary", "pistol"}
weaponArray[88] = {"tfa_doiowen", "Owen Gun", "primary", "smg"}
weaponArray[89] = {"tfa_ins2_p320_m18", "P320", "secondary", "pistol"}
weaponArray[90] = {"tfa_fml_p90_tac", "P90", "primary", "smg"}
weaponArray[91] = {"tfa_blast_pindadss2", "Pindad SS2", "primary", "rifle"}
weaponArray[92] = {"tfa_ins2_pkp", "PKP", "primary", "lmg"}
weaponArray[93] = {"tfa_ins2_pm9", "PM-9", "secondary", "smg"}
weaponArray[94] = {"tfa_fas2_ppbizon", "PP-19 Bizon", "primary", "smg"}
weaponArray[95] = {"tfa_nam_ppsh41", "PPSH", "primary", "smg"}
weaponArray[96] = {"tfa_ww2_pbz39", "PzB 39", "primary", "sniper"}
weaponArray[97] = {"tfa_ins2_norinco_qbz97", "QBZ-97", "primary", "rifle"}
weaponArray[98] = {"tfa_ins2_qsz92", "QSZ-92", "secondary", "pistol"}
weaponArray[99] = {"tfa_ins2_remington_m870", "Remington M870", "primary", "shotgun"}
weaponArray[100] = {"tfa_ins2_pd2_remington_msr", "Remington MSR", "primary", "sniper"}
weaponArray[101] = {"tfa_ins2_rfb", "RFB", "primary", "rifle"}
weaponArray[102] = {"swat_shield", "Riot Shield", "secondary", "melee"}
weaponArray[103] = {"tfa_ins2_rpg7_scoped", "RPG-7", "primary", "explosive"}
weaponArray[104] = {"tfa_ins2_rpk_74m", "RPK-74M", "primary", "lmg"}
weaponArray[105] = {"tfa_ins2_s&w_500", "S&W 500", "secondary", "pistol"}
weaponArray[106] = {"tfa_ins2_izh43sw", "Sawed Off", "secondary", "shotgun"}
weaponArray[107] = {"tfa_ins2_scar_h_ssr", "SCAR-H", "primary", "rifle"}
weaponArray[108] = {"tfa_ins2_sc_evo", "Scorpion Evo", "primary", "smg"}
...
weaponArray[113] = {"tfa_ins2_saiga_spike", "Spike X1S", "primary", "sniper"}
weaponArray[114] = {"tfa_ins2_sr2m_veresk", "SR-2M", "primary", "smg"}
weaponArray[115] = {"tfa_doisten", "Sten Gun", "primary", "smg"}
weaponArray[116] = {"tfa_nam_stevens620", "Stevens 620", "primary", "shotgun"}
weaponArray[117] = {"tfa_doistg44", "StG 44", "primary", "rifle"}
weaponArray[118] = {"tfa_ins2_sv98", "SV-98", "primary", "sniper"}
weaponArray[119] = {"tfa_ins2_warface_orsis_t5000", "T-5000", "primary", "sniper"}
...
weaponArray[125] = {"tfa_ins2_typhoon12", "Typhoon F12", "primary", "shotgun"}
weaponArray[126] = {"tfa_ins2_ump45", "UMP .45", "primary", "smg"}
weaponArray[127] = {"tfa_ins2_ump9", "UMP9", "primary", "smg"}
