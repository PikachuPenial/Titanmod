...
mapArray[4] = {"tm_firingrange", "Firing Range", "Free weapon spawning, force disabled progression.", "maps/thumb/tm_firingrange.png"}
mapArray[5] = {"tm_liminal_pool", "Liminal Pool", "Prone to sniping, many movemeny opportunities", "maps/thumb/tm_liminal_pool.png"}
mapArray[6] = {"tm_mall", "Mall", "Spacious shopping center with long sightlines.", "maps/thumb/tm_mall.png"}
mapArray[7] = {"tm_mephitic", "Mephitic", "Dark facility with a continuous acid flood.", "maps/thumb/tm_mephitic.png"}
mapArray[8] = {"tm_nuketown", "Nuketown", "Cult classic, predictible spawns and engagements.", "maps/thumb/tm_nuketown.png"}
mapArray[9] = {"tm_rig", "Rig", "Dark and rainy oil rig.", "maps/thumb/tm_rig.png"}
mapArray[10] = {"tm_shipment", "Shipment", "Extremely small and chaotic.", "maps/thumb/tm_shipment.png"}
mapArray[11] = {"tm_station", "Station", "A vertical and open battleground.", "maps/thumb/tm_station.png"}
...
weaponArray[17] = {"tfa_doibren", "Bren", "primary", ".303 British"}
...
weaponArray[25] = {"tfa_ins2_ddm4v5", "DDM4V5", "primary", "5.56x45"}
weaponArray[26] = {"tfa_ins2_deagle", "Desert Eagle", "secondary", ".50 AE"}
weaponArray[27] = {"tfa_ins2_warface_amp_dsr1", "DSR-1", "primary", ".338 Lapua"}
...
weaponArray[109] = {"tfa_ins2_spectre", "Spectre M4", "primary", "9x19"}
weaponArray[110] = {"tfa_ins2_saiga_spike", "Spike X15", "primary", "12 Gauge"}
weaponArray[111] = {"tfa_ins2_sr2m_veresk", "SR-2M Veresk", "primary", "9x21"}
weaponArray[112] = {"tfa_doisten", "Sten Mk.II", "primary", "9x19"}
weaponArray[113] = {"tfa_nam_stevens620", "Stevens 620", "primary", "12 Gauge"}
