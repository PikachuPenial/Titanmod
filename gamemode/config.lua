...
weaponArray[18] = {"tfa_ins2_warface_bt_mp9", "B&T MP9", "primary", "smg"}
weaponArray[19] = {"tfa_ins2_warface_cheytac_m200", "CheyTac M200", "primary", "sniper"}
weaponArray[20] = {"tfa_ins2_m4_9mm", "Colt 9mm", "primary", "smg"}
weaponArray[21] = {"tfa_nam_m1911", "Colt M1911", "secondary", "pistol"}
weaponArray[22] = {"tfa_ins2_colt_m45", "Colt M45A1", "secondary", "pistol"}
weaponArray[23] = {"tfa_ins2_cz75", "CZ 75 B", "secondary", "pistol"}
weaponArray[24] = {"tfa_ins2_cz805", "CZ 805", "primary", "rifle"}
weaponArray[25] = {"tfa_ins2_ddm4v5", "DDM4V5", "primary", "rifle"}
weaponArray[26] = {"tfa_ins2_deagle", "Desert Eagle", "secondary", "pistol"}
weaponArray[27] = {"tfa_ins2_warface_amp_dsr1", "DSR-1", "primary", "sniper"}
weaponArray[28] = {"tfa_l4d2_skorpion_dual", "Dual Skorpions", "primary", "pistol"}
weaponArray[29] = {"tfa_ins2_famas", "Famas F1", "primary", "rifle"}
weaponArray[30] = {"tfa_blast_lynx_msbsb", "FB MSBS-B", "primary", "rifle"}
...
weaponArray[38] = {"tfa_glk_gen4", "Glock 17", "secondary", "pistol"}
...
weaponArray[49] = {"tfa_blast_ksvk_cqb", "KSVK 12.7", "primary", "sniper"}
weaponArray[50] = {"tfa_doi_enfield", "Lee-Enfield No. 4", "primary", "sniper"}
...
weaponArray[54] = {"tfa_doim3greasegun", "M3 Grease Gun", "secondary", "smg"}
weaponArray[55] = {"tfa_ins2_eftm4a1", "M4A1", "primary", "rifle"}
weaponArray[56] = {"tfa_ins2_m9", "M9", "secondary", "pistol"}
weaponArray[57] = {"tfa_ins2_m14retro", "M14", "primary", "rifle"}
weaponArray[58] = {"tfa_nam_m79", "M79", "primary", "explosive"}
weaponArray[59] = {"tfa_doim1918", "M1918", "primary", "lmg"}
weaponArray[60] = {"tfa_doim1919", "M1919", "primary", "lmg"}
weaponArray[61] = {"tfa_ins2_minimi", "M249", "primary", "lmg"}
weaponArray[62] = {"bocw_mac10_alt", "Mac 10", "secondary", "smg"}
weaponArray[63] = {"tfa_ins2_pm", "Makarov", "secondary", "pistol"}
weaponArray[64] = {"tfa_tfre_maresleg", "Mare's Leg", "secondary", "pistol"}
weaponArray[65] = {"tfa_fml_lefrench_mas38", "Mas 38", "primary", "smg"}
weaponArray[66] = {"tfa_doimg34", "MG 34", "primary", "lmg"}
weaponArray[67] = {"tfa_doimg42", "MG 42", "primary", "lmg"}
weaponArray[68] = {"tfa_ins2_mk23", "MK 23", "secondary", "pistol"}
weaponArray[69] = {"tfa_fml_inss_mk18", "MK18", "primary", "rifle"}
weaponArray[70] = {"tfa_ins2_mk14ebr", "Mk 14 EBR", "primary", "rifle"}
weaponArray[71] = {"tfa_ins2_swmodel10", "Model 10", "secondary", "pistol"}
weaponArray[72] = {"tfa_ins2_mosin_nagant", "Mosin Nagant", "primary", "sniper"}
weaponArray[73] = {"tfa_doimp40", "MP 40", "primary", "smg"}
weaponArray[74] = {"tfa_ins2_mp443", "MP-443", "secondary", "pistol"}
weaponArray[75] = {"tfa_ins2_mp5k", "MP5K", "secondary", "smg"}
weaponArray[76] = {"tfa_ins2_mp7", "MP7A1", "primary", "smg"}
weaponArray[77] = {"tfa_ww1_mp18", "MP18", "primary", "smg"}
weaponArray[78] = {"tfa_inss2_hk_mp5a5", "MP5", "primary", "smg"}
weaponArray[79] = {"tfa_ins2_mr96", "MR-96", "secondary", "pistol"}
weaponArray[80] = {"tfa_ins2_mc255", "MTs225-12", "primary", "shotgun"}
weaponArray[81] = {"tfa_ins2_nova", "Nova", "primary", "shotgun"}
weaponArray[82] = {"tfa_ins2_warface_orsis_t5000", "Orsis T-5000", "primary", "sniper"}
weaponArray[83] = {"tfa_l4d2_osp18", "OSP-18", "secondary", "pistol"}
weaponArray[84] = {"tfa_ins2_groza", "OTs-14 Groza", "primary", "rifle"}
weaponArray[85] = {"tfa_ins2_ots_33_pernach", "OTs-33 Pernach", "secondary", "pistol"}
weaponArray[86] = {"tfa_doiowen", "Owen Mk.I", "primary", "smg"}
weaponArray[87] = {"tfa_fml_p90_tac", "P90", "primary", "smg"}
weaponArray[88] = {"tfa_blast_pindadss2", "PINDAD SS2-V1", "primary", "rifle"}
weaponArray[89] = {"tfa_ins2_pm9", "PM-9", "primary", "smg"}
weaponArray[90] = {"tfa_nam_ppsh41", "PPSH-41", "primary", "smg"}
weaponArray[91] = {"tfa_fas2_ppbizon", "PP-19 Bizon", "primary", "smg"}
weaponArray[92] = {"tfa_ww2_pbz39", "PzB 39", "primary", "sniper"}
weaponArray[93] = {"tfa_ins2_norinco_qbz97", "QBZ-97", "primary", "rifle"}
weaponArray[94] = {"tfa_ins2_qsz92", "QSZ-92", "secondary", "pistol"}
weaponArray[95] = {"tfa_ins2_remington_m870", "Remington M870", "primary", "shotgun"}
weaponArray[96] = {"tfa_ins2_pd2_remington_msr", "Remington MSR", "primary", "sniper"}
weaponArray[97] = {"tfa_ins2_rfb", "RFB", "primary", "rifle"}
weaponArray[98] = {"swat_shield", "Riot Shield", "secondary", "melee"}
weaponArray[99] = {"tfa_fml_rk62", "RK62", "primary", "rifle"}
weaponArray[100] = {"tfa_ins2_rpg7_scoped", "RPG-7", "primary", "explosive"}
weaponArray[101] = {"tfa_ins2_rpk_74m", "RPK-74M", "primary", "lmg"}
weaponArray[102] = {"tfa_ins2_l85a2", "SA80", "primary", "rifle"}
weaponArray[103] = {"tfa_ins2_izh43sw", "Sawed Off", "secondary", "shotgun"}
weaponArray[104] = {"tfa_ins2_scar_h_ssr", "SCAR-H", "primary", "rifle"}
weaponArray[105] = {"tfa_ins2_sc_evo", "Scorpion Evo", "primary", "smg"}
weaponArray[106] = {"tfa_ins2_p320_m18", "SIG P320", "secondary", "pistol"}
weaponArray[107] = {"tfa_l4d2_skorpion", "Skorpion", "secondary", "pistol"}
weaponArray[108] = {"tfa_ins2_sks", "SKS", "primary", "rifle"}
weaponArray[109] = {"tfa_ins2_spas12", "SPAS-12", "primary", "shotgun"}
weaponArray[110] = {"tfa_ins2_spectre", "Spectre M4", "primary", "smg"}
weaponArray[111] = {"tfa_ins2_saiga_spike", "Spike X15", "primary", "shotgun"}
weaponArray[112] = {"tfa_ins2_sr2m_veresk", "SR-2M Veresk", "primary", "smg"}
weaponArray[113] = {"tfa_doisten", "Sten Mk.II", "primary", "smg"}
weaponArray[114] = {"tfa_nam_stevens620", "Stevens 620", "primary", "shotgun"}
weaponArray[115] = {"tfa_doistg44", "StG44", "primary", "rifle"}
weaponArray[116] = {"tfa_ins2_sv98", "SV-98", "primary", "sniper"}
weaponArray[117] = {"tfa_ins2_s&w_500", "S&W 500", "secondary", "pistol"}
weaponArray[118] = {"tfa_japanese_exclusive_tanto", "Tanto", "melee"}
weaponArray[119] = {"tfa_ins_sandstorm_tariq", "Tariq", "secondary", "9x19"}
weaponArray[120] = {"st_stim_pistol", "TCo Stim Pistol", "secondary", "pistol"}
weaponArray[121] = {"tfa_doithompsonm1928", "Thompson M1928", "primary", "smg"}
weaponArray[122] = {"tfa_doithompsonm1a1", "Thompson M1A1", "primary", "smg"}
weaponArray[123] = {"tfa_ins2_type81", "Type 81", "primary", "rifle"}
weaponArray[124] = {"tfa_ins2_typhoon12", "Typhoon F12", "primary", "shotgun"}
weaponArray[125] = {"tfa_ins2_ump45", "UMP .45", "primary", "smg"}
weaponArray[126] = {"tfa_ins2_ump9", "UMP9", "primary", "smg"}
weaponArray[127] = {"tfa_ins2_imi_uzi", "Uzi", "secondary", "smg"}
weaponArray[128] = {"tfa_ins2_br99", "UZK-BR99", "primary", "shotgun"}
weaponArray[129] = {"tfa_ins2_vhsd2", "VHS-D2", "primary", "rifle"}
weaponArray[130] = {"tfa_ins2_walther_p99", "Walther P99", "secondary", "pistol"}
