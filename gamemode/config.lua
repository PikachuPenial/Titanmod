...
weaponArray[17] = {"tfa_ins2_br99", "BR99", "primary", "shotgun"}
weaponArray[18] = {"tfa_doibren", "Bren", "primary", "lmg"}
weaponArray[19] = {"tfa_ins2_m4_9mm", "Colt 9mm", "primary", "smg"}
weaponArray[20] = {"rust_crossbow", "Crossbow", "primary", "sniper"}
weaponArray[21] = {"tfa_ins2_cz75", "CZ 75", "secondary", "pistol"}
weaponArray[22] = {"tfa_ins2_cz805", "CZ 805", "primary", "rifle"}
weaponArray[23] = {"tfa_ins2_deagle", "Desert Eagle", "secondary", "pistol"}
weaponArray[24] = {"tfa_ins2_warface_amp_dsr1", "DSR-50", "primary", "sniper"}
weaponArray[25] = {"tfa_l4d2_skorpion_dual", "Dual Skorpions", "primary", "pistol"}
weaponArray[26] = {"tfa_ins2_famas", "FAMAS", "primary", "rifle"}
weaponArray[27] = {"tfa_doifg42", "FG 42", "primary", "lmg"}
weaponArray[28] = {"tfa_ins2_fiveseven_eft", "Fiveseven", "secondary", "pistol"}
weaponArray[29] = {"tfa_ins2_fn_2000", "FN 2000", "primary", "rifle"}
weaponArray[30] = {"tfa_ins2_fn_fal", "FN FAL", "primary", "rifle"}
weaponArray[31] = {"tfa_ins2_fnp45", "FNP-45", "secondary", "pistol"}
weaponArray[32] = {"tfa_ins2_g28", "G28", "primary", "rifle"}
weaponArray[33] = {"tfa_ins2_g36a1", "G36A1", "primary", "rifle"}
weaponArray[34] = {"tfa_glk_gen4", "Glock 18", "secondary", "pistol"}
weaponArray[35] = {"fres_grapple", "Grappling Hook", "gadget"}
weaponArray[36] = {"grenade", "Grenade", "none"} -- We have a grenade entry for kill tracking
weaponArray[37] = {"tfa_ins2_groza", "Groza", "primary", "rifle"}
...
weaponArray[43] = {"tfa_ins2_warface_cheytac_m200", "Intervention", "primary", "sniper"}
...
weaponArray[52] = {"tfa_ins2_m14retro", "M14", "primary", "rifle"}
weaponArray[53] = {"tfa_nam_m1911", "M1911", "secondary", "pistol"}
weaponArray[54] = {"tfa_doim1918", "M1918", "primary", "lmg"}
weaponArray[55] = {"tfa_doim1919", "M1919", "primary", "lmg"}
weaponArray[56] = {"tfa_ins2_minimi", "M249", "primary", "lmg"}
weaponArray[57] = {"tfa_doim3greasegun", "M3 Grease Gun", "secondary", "smg"}
weaponArray[58] = {"tfa_ins2_colt_m45", "M45A1", "secondary", "pistol"}
weaponArray[59] = {"tfa_ins2_eftm4a1", "M4A1", "primary", "rifle"}
weaponArray[60] = {"tfa_nam_m79", "M79", "primary", "explosive"}
weaponArray[61] = {"tfa_ins2_m9", "M9", "secondary", "pistol"}
weaponArray[62] = {"bocw_mac10_alt", "Mac 10", "secondary", "smg"}
weaponArray[63] = {"tfa_ararebo_bf1", "Mace", "melee"}
weaponArray[64] = {"tfa_ins2_pm", "Makarov", "secondary", "pistol"}
weaponArray[65] = {"tfa_tfre_maresleg", "Mare's Leg", "secondary", "pistol"}
weaponArray[66] = {"tfa_fml_lefrench_mas38", "Mas 38", "primary", "smg"}
weaponArray[67] = {"tfa_doimg34", "MG 34", "primary", "lmg"}
weaponArray[68] = {"tfa_doimg42", "MG 42", "primary", "lmg"}
weaponArray[69] = {"tfa_ins2_mk14ebr", "MK 14 EBR", "primary", "rifle"}
weaponArray[70] = {"tfa_ins2_mk23", "MK 23", "secondary", "pistol"}
weaponArray[71] = {"tfa_fml_inss_mk18", "MK18", "primary", "rifle"}
weaponArray[72] = {"tfa_ins2_swmodel10", "Model 10", "secondary", "pistol"}
weaponArray[73] = {"tfa_ins2_mosin_nagant", "Mosin Nagant", "primary", "sniper"}
weaponArray[74] = {"tfa_doimp40", "MP 40", "primary", "smg"}
weaponArray[75] = {"tfa_ins2_mp443", "MP-443", "secondary", "pistol"}
weaponArray[76] = {"tfa_ww1_mp18", "MP18", "primary", "smg"}
weaponArray[77] = {"tfa_inss2_hk_mp5a5", "MP5", "primary", "smg"}
weaponArray[78] = {"tfa_ins2_mp5k", "MP5K", "secondary", "smg"}
weaponArray[79] = {"tfa_ins2_mp7", "MP7", "primary", "smg"}
weaponArray[80] = {"tfa_ins2_warface_bt_mp9", "MP9", "primary", "smg"}
weaponArray[81] = {"tfa_ins2_mr96", "MR-96", "secondary", "pistol"}
weaponArray[82] = {"tfa_ins2_mc255", "MTs225", "primary", "shotgun"}
weaponArray[83] = {"tfa_ins2_nova", "Nova", "primary", "shotgun"}
weaponArray[84] = {"tfa_l4d2_osp18", "OSP-18", "secondary", "pistol"}
weaponArray[85] = {"tfa_ins2_ots_33_pernach", "OTs-33 Pernach", "secondary", "pistol"}
weaponArray[86] = {"tfa_doiowen", "Owen Gun", "primary", "smg"}
weaponArray[87] = {"tfa_ins2_p320_m18", "P320", "secondary", "pistol"}
weaponArray[88] = {"tfa_fml_p90_tac", "P90", "primary", "smg"}
weaponArray[89] = {"tfa_blast_pindadss2", "Pindad SS2", "primary", "rifle"}
weaponArray[90] = {"tfa_ins2_pkp", "PKP", "primary", "lmg"}
weaponArray[91] = {"tfa_ins2_pm9", "PM-9", "secondary", "smg"}
weaponArray[92] = {"tfa_fas2_ppbizon", "PP-19 Bizon", "primary", "smg"}
weaponArray[93] = {"tfa_nam_ppsh41", "PPSH", "primary", "smg"}
...
weaponArray[101] = {"tfa_ins2_rpg7_scoped", "RPG-7", "primary", "explosive"}
weaponArray[102] = {"tfa_ins2_rpk_74m", "RPK-74M", "primary", "lmg"}
weaponArray[103] = {"tfa_ins2_s&w_500", "S&W 500", "secondary", "pistol"}
...
weaponArray[108] = {"tfa_l4d2_skorpion", "Skorpion", "secondary", "pistol"}
weaponArray[109] = {"tfa_ins2_sks", "SKS", "primary", "rifle"}
weaponArray[110] = {"tfa_ins2_spas12", "SPAS-12", "primary", "shotgun"}
weaponArray[111] = {"tfa_ins2_spectre", "Spectre M4", "primary", "smg"}
weaponArray[112] = {"tfa_ins2_saiga_spike", "Spike X1S", "primary", "sniper"}
weaponArray[113] = {"tfa_ins2_sr2m_veresk", "SR-2M", "primary", "smg"}
weaponArray[114] = {"tfa_doisten", "Sten Gun", "primary", "smg"}
weaponArray[115] = {"tfa_nam_stevens620", "Stevens 620", "primary", "shotgun"}
weaponArray[116] = {"tfa_doistg44", "StG 44", "primary", "rifle"}
weaponArray[117] = {"tfa_ins2_sv98", "SV-98", "primary", "sniper"}
weaponArray[118] = {"tfa_ins2_warface_orsis_t5000", "T-5000", "primary", "sniper"}
weaponArray[119] = {"tfa_japanese_exclusive_tanto", "Tanto", "melee"}
weaponArray[120] = {"tfa_ins_sandstorm_tariq", "Tariq", "secondary", "9x19"}
weaponArray[121] = {"st_stim_pistol", "TCo Stim Pistol", "secondary", "pistol"}
weaponArray[122] = {"tfa_doithompsonm1928", "Thompson M1928", "primary", "smg"}
weaponArray[123] = {"tfa_doithompsonm1a1", "Thompson M1A1", "primary", "smg"}
...
weaponArray[127] = {"tfa_ins2_usp_match", "USP", "secondary", "pistol"}
weaponArray[128] = {"tfa_ins2_imi_uzi", "Uzi", "secondary", "smg"}
