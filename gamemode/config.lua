...
weaponArray[43] = {"ryry_tfa_chainsaw", "KAC ChainSAW", "primary", "lmg"}
weaponArray[44] = {"tfa_km2000_knife", "KM-2000", "melee"}
weaponArray[45] = {"tfa_ins2_krissv", "KRISS Vector", "primary", "smg"}
weaponArray[46] = {"tfa_ins2_ksg", "KSG", "primary", "shotgun"}
weaponArray[47] = {"tfa_doi_enfield", "Lee Enfield", "primary", "sniper"}
weaponArray[48] = {"tfa_doilewis", "Lewis", "primary", "lmg"}
weaponArray[49] = {"tfa_ins2_zm_lr300", "LR-300", "primary", "rifle"}
weaponArray[50] = {"tfa_doi_garand", "M1 Garand", "primary", "rifle"}
weaponArray[51] = {"tfa_doim3greasegun", "M3 Grease Gun", "secondary", "smg"}
weaponArray[52] = {"tfa_ins2_eftm4a1", "M4A1", "primary", "rifle"}
weaponArray[53] = {"tfa_ins2_m9", "M9", "secondary", "pistol"}
weaponArray[54] = {"tfa_ins2_m14retro", "M14", "primary", "rifle"}
weaponArray[55] = {"tfa_nam_m79", "M79", "primary", "explosive"}
...
weaponArray[59] = {"bocw_mac10_alt", "Mac 10", "secondary", "smg"}
weaponArray[60] = {"tfa_ararebo_bf1", "Mace", "melee"}
weaponArray[61] = {"tfa_ins2_pm", "Makarov", "secondary", "pistol"}
weaponArray[62] = {"tfa_tfre_maresleg", "Mare's Leg", "secondary", "pistol"}
weaponArray[63] = {"tfa_fml_lefrench_mas38", "Mas 38", "primary", "smg"}
weaponArray[64] = {"tfa_doimg34", "MG 34", "primary", "lmg"}
weaponArray[65] = {"tfa_doimg42", "MG 42", "primary", "lmg"}
weaponArray[66] = {"tfa_ins2_mk23", "MK 23", "secondary", "pistol"}
weaponArray[67] = {"tfa_ins2_mk14ebr", "Mk 14 EBR", "primary", "rifle"}
weaponArray[68] = {"tfa_fml_inss_mk18", "MK18", "primary", "rifle"}
weaponArray[69] = {"tfa_ins2_swmodel10", "Model 10", "secondary", "pistol"}
weaponArray[70] = {"tfa_ins2_mosin_nagant", "Mosin Nagant", "primary", "sniper"}
weaponArray[71] = {"tfa_doimp40", "MP 40", "primary", "smg"}
weaponArray[72] = {"tfa_ins2_mp5k", "MP5K", "secondary", "smg"}
weaponArray[73] = {"tfa_inss2_hk_mp5a5", "MP5", "primary", "smg"}
weaponArray[74] = {"tfa_ins2_mp7", "MP7", "primary", "smg"}
weaponArray[75] = {"tfa_ins2_warface_bt_mp9", "MP9", "primary", "smg"}
weaponArray[76] = {"tfa_ww1_mp18", "MP18", "primary", "smg"}
weaponArray[77] = {"tfa_ins2_mp443", "MP-443", "secondary", "pistol"}
weaponArray[78] = {"tfa_ins2_mr96", "MR-96", "secondary", "pistol"}
weaponArray[79] = {"tfa_ins2_mc255", "MTs225", "primary", "shotgun"}
weaponArray[80] = {"tfa_ins2_nova", "Nova", "primary", "shotgun"}
weaponArray[81] = {"tfa_l4d2_osp18", "OSP-18", "secondary", "pistol"}
weaponArray[82] = {"tfa_ins2_groza", "OTs-14 Groza", "primary", "rifle"}
weaponArray[83] = {"tfa_ins2_ots_33_pernach", "OTs-33 Pernach", "secondary", "pistol"}
weaponArray[84] = {"tfa_doiowen", "Owen Gun", "primary", "smg"}
weaponArray[85] = {"tfa_fml_p90_tac", "P90", "primary", "smg"}
weaponArray[86] = {"tfa_blast_pindadss2", "PINDAD SS2", "primary", "rifle"}
weaponArray[87] = {"tfa_ins2_pkp", "PKP", "primary", "lmg"}
weaponArray[88] = {"tfa_ins2_pm9", "PM-9", "secondary", "smg"}
weaponArray[89] = {"tfa_nam_ppsh41", "PPSH", "primary", "smg"}
weaponArray[90] = {"tfa_fas2_ppbizon", "PP-19 Bizon", "primary", "smg"}
weaponArray[91] = {"tfa_ww2_pbz39", "PzB 39", "primary", "sniper"}
weaponArray[92] = {"tfa_ins2_norinco_qbz97", "QBZ-97", "primary", "rifle"}
weaponArray[93] = {"tfa_ins2_qsz92", "QSZ-92", "secondary", "pistol"}
weaponArray[94] = {"tfa_ins2_remington_m870", "Remington M870", "primary", "shotgun"}
weaponArray[95] = {"tfa_ins2_pd2_remington_msr", "Remington MSR", "primary", "sniper"}
weaponArray[96] = {"tfa_ins2_rfb", "RFB", "primary", "rifle"}
weaponArray[97] = {"swat_shield", "Riot Shield", "secondary", "melee"}
weaponArray[98] = {"tfa_ins2_rpg7_scoped", "RPG-7", "primary", "explosive"}
weaponArray[99] = {"tfa_ins2_rpk_74m", "RPK-74M", "primary", "lmg"}
weaponArray[100] = {"tfa_ins2_l85a2", "SA80", "primary", "rifle"}
weaponArray[101] = {"tfa_ins2_izh43sw", "Sawed Off", "secondary", "shotgun"}
weaponArray[102] = {"tfa_ins2_scar_h_ssr", "SCAR-H", "primary", "rifle"}
weaponArray[103] = {"tfa_ins2_sc_evo", "Scorpion Evo", "primary", "smg"}
weaponArray[104] = {"tfa_ins2_p320_m18", "SIG P320", "secondary", "pistol"}
weaponArray[105] = {"tfa_l4d2_skorpion", "Skorpion", "secondary", "pistol"}
weaponArray[106] = {"tfa_ins2_sks", "SKS", "primary", "rifle"}
weaponArray[107] = {"tfa_ins2_spas12", "SPAS-12", "primary", "shotgun"}
weaponArray[108] = {"tfa_ins2_spectre", "Spectre M4", "primary", "smg"}
weaponArray[109] = {"tfa_ins2_saiga_spike", "Spike X15", "primary", "sniper"}
weaponArray[110] = {"tfa_ins2_sr2m_veresk", "SR-2M", "primary", "smg"}
weaponArray[111] = {"tfa_doisten", "Sten Gun", "primary", "smg"}
weaponArray[112] = {"tfa_nam_stevens620", "Stevens 620", "primary", "shotgun"}
weaponArray[113] = {"tfa_doistg44", "StG 44", "primary", "rifle"}
weaponArray[114] = {"tfa_ins2_sv98", "SV-98", "primary", "sniper"}
weaponArray[115] = {"tfa_ins2_s&w_500", "S&W 500", "secondary", "pistol"}
weaponArray[116] = {"tfa_japanese_exclusive_tanto", "Tanto", "melee"}
weaponArray[117] = {"tfa_ins_sandstorm_tariq", "Tariq", "secondary", "9x19"}
weaponArray[118] = {"st_stim_pistol", "TCo Stim Pistol", "secondary", "pistol"}
weaponArray[119] = {"tfa_doithompsonm1928", "Thompson M1928", "primary", "smg"}
weaponArray[120] = {"tfa_doithompsonm1a1", "Thompson M1A1", "primary", "smg"}
weaponArray[121] = {"tfa_ins2_typhoon12", "Typhoon F12", "primary", "shotgun"}
weaponArray[122] = {"tfa_ins2_warface_orsis_t5000", "T-5000", "primary", "sniper"}
weaponArray[123] = {"tfa_ins2_ump45", "UMP .45", "primary", "smg"}
weaponArray[124] = {"tfa_ins2_ump9", "UMP9", "primary", "smg"}
weaponArray[125] = {"tfa_ins2_usp_match", "USP", "secondary", "pistol"}
weaponArray[126] = {"tfa_ins2_imi_uzi", "Uzi", "secondary", "smg"}
weaponArray[127] = {"tfa_ins2_br99", "UZK-BR99", "primary", "shotgun"}
weaponArray[128] = {"tfa_ins2_vhsd2", "VHS-D2", "primary", "rifle"}
weaponArray[129] = {"tfa_ins2_walther_p99", "Walther P99", "secondary", "pistol"}
