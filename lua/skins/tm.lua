...
SKIN.PrintName  = "Titanmod Derma Skin"
SKIN.Author		= "Penial"
SKIN.DermaVersion	= 1
SKIN.GwenTexture	= Material("gwenskin/tm.png")
...
derma.DefineSkin("Titanmod Derma Skin", "Custom Derma skin for use in Titanmod", SKIN);
derma.RefreshSkins();