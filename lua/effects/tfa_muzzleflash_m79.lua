...
function EFFECT:Init(data)
    ...
    ParticleEffectAttach("muzzleflash_m79", PATTACH_POINT_FOLLOW, self.WeaponEnt, data:GetAttachment())    

	if GetConVar("cl_tfa_rms_smoke_shock"):GetFloat() >= 1 then
	    ParticleEffectAttach("muzzle_smoke_shock_medium", PATTACH_POINT_FOLLOW, self.WeaponEnt, data:GetAttachment())
    end	
