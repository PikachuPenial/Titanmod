...
ATTACHMENT.Description = {
	...
	TFA.AttachmentColors["-"], "450% more recoil",
...
ATTACHMENT.WeaponTable = {
	...
	["Primary"] = {
		...
		["KickUp"] = function( wep, stat ) return stat * 4.5 end,
		["KickHorizontal"] = function( wep, stat ) return stat * 4.5 end,
		["KickDown"] = function( wep, stat ) return stat * 4.5 end,
