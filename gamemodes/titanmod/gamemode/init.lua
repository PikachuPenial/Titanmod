...
function GM:PlayerInitialSpawn(ply)
	...
	if (ply:GetPData("highestKillStreak") == nil) then ply:SetNWInt("highestKillStreak", 1) else ply:SetNWInt("highestKillStreak", tonumber(ply:GetPData("highestKillStreak"))) end
end
