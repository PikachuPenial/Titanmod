...
function PlayerModelChange(ply, cmd, args)
	...
	modelList[7] = {"models/player/Group01/male_07.mdl", "Male 07", "The one, the only.", "kills", 100}
	modelList[8] = {"models/player/alyx.mdl", "Alyx", "Half-Life 3.", "kills", 300}
	modelList[9] = {"models/player/hostage/hostage_04.mdl", "Scientist", "Bill Nye.", "kills", 500}
	modelList[10] = {"models/player/combine_super_soldier.mdl", "Super Soilder", "Very super.", "kills", 1000}
	modelList[11] = {"models/player/p2_chell.mdl", "Chell", "Funny portal reference.", "kills", 2000}
	modelList[12] = {"models/player/leet.mdl", "Badass", "So cool.", "kills", 3000}
	modelList[13] = {"models/player/arctic.mdl", "Arctic", "I don't think it's cold in here.", "streak", 5}
	modelList[14] = {"models/player/riot.mdl", "Riot", "Tanto Addict.", "streak", 10}
	modelList[15] = {"models/player/gasmask.mdl", "Hazmat Suit", "This isn't Rust.", "streak", 15}
	modelList[16] = {"models/player/police.mdl", "Officer", "Pick up the can.", "streak", 20}
	modelList[17] = {"models/player/combine_soldier_prisonguard.mdl", "Cobalt Soilder", "No green card?", "streak", 25}
	modelList[18] = {"models/walterwhite/playermodels/walterwhitechem.mdl", "Drug Dealer", "waltuh.", "streak", 30}
	modelList[19] = {"models/cyanblue/fate/astolfo/astolfo.mdl", "Astolfo", "I was forced to do this.", "special", "name"}
